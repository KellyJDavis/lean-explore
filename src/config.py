...
This module provides a convenient import path for scripts that add src/ to sys.path.
It re-exports APP_CONFIG and get_gemini_api_key from dev_tools.config.
