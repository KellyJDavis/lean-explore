...
This document describes how to publish new versions of `lean-explore` to PyPI.
...
# Edit pyproject.toml and change: version = "0.3.1"
...
# Test installation
pip install --index-url https://test.pypi.org/simple/ --extra-index-url https://pypi.org/simple/ lean-explore
```
...
- **MINOR** version (0.4.0): New functionality, backwards compatible
- **PATCH** version (0.3.1): Bug fixes, backwards compatible
...
The tag version must match the version in `pyproject.toml`. If you tagged `v0.3.1` but `pyproject.toml` has `0.3.0`, the workflow will fail.
